...
@component('mail::button', ['url' => route('register.verifyEmail', $user->verification_token)])
Verify E-Mail address
@endcomponent

Alternatively, you can copy and paste the below link in your browser to verify your email address.

<a href="{{ route('register.verifyEmail', $user->verification_token) }}">{{ route('register.verifyEmail', $user->verification_token) }}</a>
