    ...
    <section class="px-6 py-6 items-center justify-center">
        <div class="container max-w-lg mx-auto flex-1 flex flex-col items-center justify-center px-2">
            <div class="bg-white px-6 py-8 rounded shadow-md text-black w-full">
                ...
                <form method="POST" action="{{ route('pages.site.store') }}" id="formManageSite">
                    @csrf
...
@section('pageScript')
<span style="color:red;">{!! JsValidator::formRequest('App\Http\Requests\ManageSiteRequest', '#formManageSite'); !!}</span> 
@endsection
