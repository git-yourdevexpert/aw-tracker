    ...
    <section class="px-6 py-6">
        <div class="container max-w-lg mx-auto flex-1 flex flex-col items-center justify-center px-2">
            <div class="bg-white px-6 py-8 rounded shadow-md text-black w-full">
                ...
                <form method="POST" action="{{ route('registerBilling.store', $company->id) }}"
                    id="formBillingInfoRegister">
                    @csrf
...
@section('pageScript')
    {!! JsValidator::formRequest('App\Http\Requests\BillingInfoRegistrationRequest', '#formBillingInfoRegister') !!}
