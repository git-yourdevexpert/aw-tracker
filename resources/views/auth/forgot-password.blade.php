    ...
    <section class="px-6 py-6">
        <div class="container max-w-lg mx-auto flex-1 flex flex-col items-center justify-center px-2">
            <div class="bg-white px-6 py-8 rounded shadow-md text-black w-full">
                ...
                <p class="text-sm text-gray-600 leading-relaxed tracking-wide">We will send a password reset link to the
                    email address that you will provide in the below text box field</p>
            ...
            <div class="text-gray-700 mt-6">
                ...
                <a href="{{ route('login') }}"
                    class="text-green-700 hover:text-green-800 transition ease-in-out duration-300">Login</a>
            </div>
        </div>
    </section>
@endsection
