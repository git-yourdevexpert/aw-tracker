            ...
            <div class="bg-white px-6 py-6 mt-6 rounded-md shadow-md text-gray-700 w-full">
                <div class="flex flex-wrap">
                    <div class="w-full md:w-1/3">
                        ...
                        <p class="mt-4 text-sm text-gray-600 tracking-wider pr-4">Update your general settings. This will be reflected every where in the application. This First and Last Name will be visible in the generated invoice as well.</p>
                    </div>

                    <div class="mt-6 md:mt-0 w-full md:w-2/3">
                        <form action="{{ route('users.accountSettings.updateGeneral') }}" method="POST" id="formGeneralSettings">
                            @csrf
                            @method('PATCH')
            ...
            <div class="bg-white px-6 py-6 mt-12 rounded-md shadow-md text-gray-700 w-full">
                <div class="flex flex-wrap">
                    <div class="w-full md:w-1/3">
                        ...
                        <p class="mt-4 text-sm text-gray-600 tracking-wider pr-6">Update your password here. Whenever you login next time, you will have to use the new and updated password.</p>
                    </div>
