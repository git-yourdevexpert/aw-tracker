<div class="bg-white px-6 py-6 mt-6 rounded-md shadow-md text-gray-700 w-full">
    <div class="flex flex-wrap">
        <div class="w-full md:w-1/3">
            ...
            <p class="mt-4 text-sm text-gray-600 tracking-wider pr-4">Add your credit card details. We promise it will
                never touch our servers.</p>
        </div>

        <form action="{{ route('users.subscription.storeCard') }}" method="post" id="payment-form">
            @csrf
            ...
            <button type="submit" id="btnAddCardDetails"
                ...
                <span class="btnText">Add Card</span>
            </button>
        </form>
    </div>
</div>
