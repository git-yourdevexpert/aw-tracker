<div class="bg-white px-6 py-6 mt-6 rounded-md shadow-md text-gray-700 w-full">
    <div class="flex flex-wrap">
        <div class="w-full md:w-1/3">
            ...
            <p class="mt-4 text-sm text-gray-600 tracking-wider pr-4">Select your subscription in order to continue using
                this application. The invoice will also be sent to you on registered email address.</p>
        </div>
        ...
        <form action="{{ route('users.subscription.pay') }}" method="post" id="formPlanChange">
            ...
            <button type="submit" id="btnMakePayment"
