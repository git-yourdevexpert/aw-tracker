            ...
            <div class="bg-white px-6 py-6 mt-6 rounded-md shadow-md text-gray-700 w-full">
                <div class="flex flex-wrap">
                    <div class="w-full md:w-1/3">
                        ...
                        <p class="mt-4 text-sm text-gray-600 tracking-wider pr-4">Add or update your company details. These
                            details will be used at the time of choosing a subscription during checkout.</p>
                    </div>

                    <div class="mt-6 md:mt-0 w-full md:w-2/3">
                        <form action="{{ route('users.company.update', $company->id) }}" method="POST"
                            id="formEditCompany">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="flex items-center">
                                <button type="submit" id="btnEditCompany"
