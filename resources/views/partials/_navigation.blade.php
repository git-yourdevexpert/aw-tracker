        ...
        <div class="flex items-center justify-between py-2 px-4">
            ...
            <div class="hidden sm:block my-4 sm:my-0">
                <ul class="sm:flex sm:space-x-12 space-y-4 sm:space-y-0">
                    ...
                    <li class="border-b sm:border-0 pb-2 sm:pb-0"><a href="#" class="text-gray-700 hover:text-green-700 focus:text-green-700 transition ease-in-out duration-300">Login</a></li>
                    <li><a href="#" class="block sm:inline py-2 px-4 rounded text-white bg-green-700 hover:bg-gray-900 focus:bg-gray-900 text-center transition ease-in-out duration-300">Register</a></li>
                </ul>
            </div>
        </div>
    </div>
